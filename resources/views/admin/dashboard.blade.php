...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{URL::asset('mdb/admin/css/bootstrap.min.css') }}" rel="stylesheet">
    <!-- Material Design Bootstrap -->
    <link href="{{URL::asset('mdb/admin/css/mdb.min.css ') }}" rel="stylesheet">
    <!-- Your custom styles (optional) -->
    <link href="{{ URL::asset('mdb/admin/css/style.min.css ') }}" rel="stylesheet">
</head>
...
<body class="grey lighten-3">
  ...
  <!-- Navbar -->
    ...
    <!-- SCRIPTS -->
    <!-- JQuery -->
    <script type="text/javascript" src="{{URL::asset('mdb/admin/js/jquery-3.3.1.min.js ')}}"></script>
    <!-- Bootstrap tooltips -->
    <script type="text/javascript" src="{{URL::asset('mdb/admin/js/popper.min.js ')}}"></script>
    <!-- Bootstrap core JavaScript -->
    <script type="text/javascript" src="{{URL::asset('mdb/admin/js/bootstrap.min.js ')}}"></script>
    <!-- MDB core JavaScript -->
    <script type="text/javascript" src="{{URL::asset('mdb/admin/js/mdb.min.js ')}}"></script>
    <!-- Initializations -->
