...
<html lang="en">
  <head>
    ...
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js"></script>
		<script src="{{ URL::asset('wysiwg/external/jquery.hotkeys.js')}}"></script>
    <script src="http://netdna.bootstrapcdn.com/twitter-bootstrap/2.3.1/js/bootstrap.min.js"></script>
    <script src="{{ URL::asset('wysiwg/external/google-code-prettify/prettify.js ')}}"></script>
		<link href="{{ URL::asset('wysiwg/index.css ')}}" rel="stylesheet">
    <script src="{{ URL::asset('wysiwg/bootstrap-wysiwyg.js ')}}"></script>
  </head>
  <body>
