...
<head>
 ...
 <title>Home Assign-Home</title>
  ...
  <style type="{{ URL::asset('mdb/landing/text/css')}}">
    html,
    body,
    header,
    .view {
...
<body>
  ...
  <!-- Full Page Intro -->
  <div class="view full-page-intro" style="background-image: url('{{ asset("/mdb/landing/img/landing-img1.png") }}'); background-repeat: no-repeat; background-size: cover;">
