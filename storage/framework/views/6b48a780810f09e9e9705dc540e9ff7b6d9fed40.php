...
<head>
 ...
 <title>Home Assign-Home</title>
  ...
  <!-- Bootstrap core CSS -->
  <link href="<?php echo e(URL::asset('mdb/landing/css/bootstrap.min.css')); ?>" rel="stylesheet">
  <!-- Material Design Bootstrap -->
  <link href="<?php echo e(URL::asset('mdb/landing/css/mdb.min.css ')); ?>" rel="stylesheet">
  <!-- Your custom styles (optional) -->
  <link href="<?php echo e(URL::asset('mdb/landing/css/style.min.css ')); ?>" rel="stylesheet">

  <style type="<?php echo e(URL::asset('mdb/landing/text/css')); ?>">
    html,
    body,
    header,
    .view {
...
<body>
  ...
  <!-- Full Page Intro -->
  <div class="view full-page-intro" style="background-image: url('<?php echo e(asset("/mdb/landing/img/landing-img1.png")); ?>'); background-repeat: no-repeat; background-size: cover;">
      ...
      <div class="container">
        ...
        <div class="row wow fadeIn">
          ...
          <div class="col-md-6 mb-4 white-text text-center text-md-left">
            ...
            <h1 class="display-4 font-weight-bold">Have your Homework DONE Today</h1>

            <hr class="hr-light"  style="margin-bottom: 200px;">
