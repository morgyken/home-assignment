...
<head>
  ...
  <link href="<?php echo e(URL::asset('mdb/landing/css/style.css ')); ?>" rel="stylesheet">
  <style type="text/css">
    html,
    body,
    header,
...
<body>
  ...
  url('<?php echo e(asset("/mdb/landing/img/landing-img1.png")); ?>'); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="col-md-5 col-xl-4 mb-5" style="margin-left:189px; margin-top: 80px">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <?php echo $__env->make('gen/part/sign-up', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
